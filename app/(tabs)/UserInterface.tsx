...
const DynamicLayoutWithStatusBar: React.FC = () => {
  ...
  const handleButton1Press = () => {
    alert(`Hello ${inputValue}`); // Hiển thị nội dung khi bấm nút 1
  };

  const handleButton2Press = () => {
    alert(`Chào ${inputValue} em ăn cơm chưa`); // Hiển thị nội dung khi bấm nút 2
  };

  return (
    <ImageBackground
      source={{ uri: 'https://i.pinimg.com/originals/52/b7/9f/52b79f6e6e522c46443d5e4aee908fca.jpg' }} 
    ...
    >
      ...
      >
        ...
        <Image
          source={{ uri: 'https://i.pinimg.com/originals/92/ef/2d/92ef2d5e808ce3fd8bc4dca46d8c3b6d.jpg' }}
